...
I uploaded the index.html file along with an images folder that contains my photo. After uploading my files, I was led to the status page informing me that my upload was successful.
...
After successfully adding the bucket policy, I went back to the Objects tab, selected the index.html file to open it. I could also use the Object URL to access the site like I [showed](https://mycloudyfuture.com/posts/p7-s3_privacy_settings/p7){target="_blank"} previously.
...
I am very excited to have successfully host a site using S3. In the future, I would like to create a portfolio site using S3 and connect it to a custom domain using AWS' Route 53 service.

These past few days with S3 has been a great learning experience. But now I'm off to learn about databases!
