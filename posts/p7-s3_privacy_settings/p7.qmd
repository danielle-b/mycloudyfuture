...
However, I cannot access my object using the Object URL shown below because I disabled public access to my bucket.

![](images/inside_my_object.png)

When I do click the Object URL, I am led to this message:


![](images/error.png)

This error lets me know that my files are private!
...
According to the [AWS documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/security-best-practices.html){target="_blank"},there are several more ways to ensure that an S3 bucket remains private. Here are just some of security best practices for S3:
...
-   Enforce encryption of data in transit
    ...
    - This allows for the use of HTTPS to assist in preventing eavesdropping on or manipulating network traffic by using person-in-the-middle or similar attacks.
    

Amazon takes security very seriously. There are many risks involved by having an S3 bucket exposed for all the world to see. Poorly managed and misconfigured buckets can result in data breaches, uploading of malicious files, removal of files and the integrity of files being compromised. In addition, it can cost a company million of dollars. 
...
I was so glad to see that Amazon has many measures put in place to protect S3 buckets. I learned a lot security doing this challenge. I'll again explore more of S3 in a future challenge. 
