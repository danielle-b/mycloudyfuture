...
Below are some of the exercises that were at the end of the chapter. Using "tail" command to see the last 20 passwords and using grep to find passwords that contain "123".
