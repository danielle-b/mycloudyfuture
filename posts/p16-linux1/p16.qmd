...
Here is one of the exercises I did at the end of the chapter. The exercise stated to use the cat command to create a new file and append to the new file.

![](images/chapter1_linux.png)
